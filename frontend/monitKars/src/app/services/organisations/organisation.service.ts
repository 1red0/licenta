...
export class OrganisationService {
  ...
  getOrganisations(): Observable<Organisation[]> {
    return this._http.get<Organisation[]>(
      environment.baseApiUrl + 'api/Organisations'
    );
  }

  getOrganisation(id: number): Observable<Organisation> {
    return this._http.get<Organisation>(
      environment.baseApiUrl + 'api/Organisations/' + id
    );
  }

  getOrganisationName(name: string) {
    return this._http.get<Organisation>(
      environment.baseApiUrl + 'api/Organisations/name/' + name
    );
  }
  ...
  updateOrganisation(
    ...
    return this._http.put<Organisation>(
      environment.baseApiUrl + 'api/Organisations/' + id,
      Organisation
    );
  }
  ...
  deleteOrganisation(id: number): Observable<Organisation> {
    return this._http.delete<Organisation>(
      environment.baseApiUrl + 'api/Organisations/' + id
    );
  }
}
